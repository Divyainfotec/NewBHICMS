...
public class PurchasePage {
	...
	@FindBy(xpath = "//*[@title='Choose Vendor']")public WebElement selvendor;
	...
	//-------------PO-Edit
	@FindBy(xpath = "//table[@id='fixtable']//tbody[1]//tr[1]//td[1]//span")public WebElement poaction;
	...
	@FindBy(xpath="//table[@id='fixtable']//tbody[1]//tr[1]//td[11]//div")public WebElement draftstatus;
	@FindBy(xpath = "//table[@id='fixtable']//tbody[1]//tr[1]//td[11]")public WebElement savedstatus;
	...
	@FindBy(xpath = "//table[@id='fixtable']//tbody[1]//tr[1]//td[1]//span")public WebElement pubillaction;
	...
	@FindBy(xpath="//*[@type='search']")public WebElement searchitm;
	 ...
	 @FindBy(xpath="//*[@id='fixtable']//tbody//tr[1]//td[5]")public WebElement puretbillno;
	...
	//pubill delete xpath = "//a[text()='Delete Bill']
	@FindBy(linkText ="Delete Bill")public WebElement deletebillbtn;
...
//------------------------------------purchase orders
	...
	public void Getpubillfilter(String cmpny,String pjt,String vndrnme,LocalDate fromdate,LocalDate todate) throws InterruptedException, ParseException
	{
	...
	public void Getpuorderfilter(String cmpny,String pjt,LocalDate fromdate) throws InterruptedException, ParseException
	{
