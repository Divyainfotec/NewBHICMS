...
public class MenupermissionPage1 {
	WebDriver driver;
	Properties pr=new Properties();
	private final Logger logger=LoggerHelper.getLogger(MenupermissionPage1.class);
	public MenupermissionPage1(WebDriver driver)
	{
		this.driver=driver;
