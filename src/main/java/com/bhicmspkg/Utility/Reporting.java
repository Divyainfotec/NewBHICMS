...
public class Reporting extends TestListenerAdapter{
	...
	WebDriver driver;
	//com.bhicmspkg.TestBase.TestBase baseclass;
	public void onStart(ITestContext testContext)
	{
		String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());//time stamp
		String Reportname="Test-Report- Agag-Cost Management System"+timeStamp+".html";
		...
		extent.setSystemInfo("Application","AGAG-Cost Management System");
		extent.setSystemInfo("Host name","localhost");
		extent.setSystemInfo("Environemnt","QA");
		extent.setSystemInfo("Tester","DIVYA");
		
		htmlReporter.config().setDocumentTitle("BHI-Agag-Cost Management System"); // Title of report
		htmlReporter.config().setReportName("AGAGCMS -- Functional Test Automation Report"); // name of the report
